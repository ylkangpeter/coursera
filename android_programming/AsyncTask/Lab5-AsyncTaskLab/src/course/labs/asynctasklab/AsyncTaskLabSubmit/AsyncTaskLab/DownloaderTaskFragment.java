...
public class DownloaderTaskFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Integer> resourceIDs =
                this.getArguments().getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);

        // TODO: Start the DownloaderTask
        task.execute(resourceIDs.toArray(new Integer[resourceIDs.size()]));
    ...
    public class DownloaderTask extends AsyncTask<Integer, Void, String[]> {
        ...
        @Override
        protected String[] doInBackground(Integer... arrayLists) {
            return downloadTweets(arrayLists);
        }
